...
import com.example.demo_zhy_mms_miui.R;
...
public class ViewPagerIndicator extends LinearLayout
{
	 ...
	 * 指示器形状的宽度为单个Tab的1/6
	 */
	private static final float RADIO_TRIANGEL = 1.0f / COUNT_DEFAULT_TAB;
	/**
	 * tab上的内容
	 */
	 ...
	 * 标题选中时的颜色
	 */
	private static final int COLOR_TEXT_HIGHLIGHTCOLOR = 0xFFFD7580;
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh)
	{
		...
		// 初始时的偏移量
		mInitTranslationX = getWidth() / mTabVisibleCount / 2 + 20 ;
	}
